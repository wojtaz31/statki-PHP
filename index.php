...
<body>
    <form action="board.php" method="get" target="_blank">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const selectElement = document.getElementById('rulesMode')
            selectElement.selectedIndex = 0
            const widthForm = document.getElementById('width')
            widthForm.value = '10';
            const heightForm = document.getElementById('height')
            heightForm.value = '10';
            const pxlTileSize = document.getElementById('pxlTileSize')
            pxlTileSize.value = '70';
